...
```{r Load in the relevant packages will use later.}
...
```{r Read the files back and put them into a list}
...
After several filtering steps, we will have a more confident datasets with reduced false positive rate. 

Next, use this dataset to assess the clonal abundance. 
